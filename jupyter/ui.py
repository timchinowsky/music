...
class MyFrame(wx.Frame):
    ...
    def createMultiSlider(self):
        ...
        self.steps = PyoGuiMultiSlider(parent=self.panel,
                                    ...
                                    size=(300,100),
                                    style=0)
        self.steps.setYrange((0, 127))
        self.steps.setValues([115 for i in range(16)])
...
def start(s):
  global server, snd, m, am, t2, q, pos, n, fr,f, pa,sp,sc,app, mainFrame
  server = s
